...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Mapa de prueba</h3>
    ...
    <input type="hidden" name="_token" id="csrfToken" value="{{ csrf_token() }}">
        <div class="card-body" style="min-height:600px">
            ...
            <div id="legend" class="bg-white border border-dark px-3 pb-1" style="display:none;"><div class="row">
                <div class="col-md-12">
                    <div class="font-weight-bold">LEYENDA</div>
                </div>
            </div>
            </div>
        </div>
...
function iniciar() {
    ...
    vallas.then((res) => res.forEach((element, it) => {
        ...
        var icon = {
            ...
            scale : 1,
            fillColor: element.color_estado,
            fillOpacity: 1,
            strokeColor: 'black',
            strokeWeight: 1,
        };
        ...
        let legend = document.getElementById('legend');
                ...
                div.innerHTML = `<br>
                    ...
                    <div class="row mb-1" >
                     <div style="width:100px">Libre </div> 
                                    <div class="col-md-1" style="background-color:green; width:10px; "></div>
                                    <br>
                     ...
                     <div class="row mb-1" >
                                    <div style="width:100px"> {{$estado->nombre}} </div>
                                    <div class="col-md-1" style="background-color:{{$estado->color}}; width:10px; "></div>
                                    <br>
                                </div>  
                    @endforeach`;
...
<script src="https://maps.google.com/maps/api/js?key=AIzaSyCOaXdpxSzffcIU5sc_LAX8ARB9JnLhCjA&callback=iniciar">
</script>
