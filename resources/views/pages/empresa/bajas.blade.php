                            ...
                            <table id="tablacontratos" style="width:100%; border: 0;"
                                ...
                                <thead class="thead-tabla">
                                    <tr>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;" data-field="id">Precio Total</th>
                                        <th style="text-align: center; vertical-align: middle;" data-field="Inicio">Inicio</th>
                                        <th style="text-align: center; vertical-align: middle;" data-field="Fin">Fin</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($contratos as $contrato)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;" >{{ DB::table('clients')->where('id', $contrato->id_cliente)->first()->nombre }}
                                            </td>
                                            <td style="text-align: center; vertical-align: middle;">{{ $contrato->precio }}€</td>
        ...
        $(document).ready(function() {
            $('#tablacontratos').DataTable({
                ...
                buttons: [{
                    ...
                    action: () => {
                        window.location.href = "{{ url('/contratos/contratoForm') }}";
                    }
                }]
            });
