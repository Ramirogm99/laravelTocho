...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-primary p-0">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="{{ url('/') }}" class="nav-link">
                        <i class="fa fas fa-arrow-left"></i> Volver
                    </a>
                </li>
            </ul>
        </div>
    ...
    <footer class="main-footer">
        ...
        <div class="float-right d-none d-sm-block">
            <strong>Copyright © 2022 <a target="_blank" href="https://toplevelsl.eu"><img style="width: 90px; margin-right:20px;" src="http://192.168.1.51/tiendas.toplevelsl.eu//assets/img/top.jpeg"></a>.</strong>
            
            </div>
            <div class=" d-none d-sm-inline-block" style="margin-left:20px;">
                <b>Versión</b> 0.0.1
            </div>
    </footer>
