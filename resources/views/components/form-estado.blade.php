<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            ...
            @if ($modo == 'update')
                <form action='{{ url("estados/update/$estado->id") }}' class="my_form row"
                    enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @elseif($modo == 'create')
                    <form action="{{ url('estados/insert') }}" class="my_form row" enctype="multipart/form-data"
    ...
    <div class="col-12">
        ...
        <div class="card card-primary">
            <div class="card-footer">
                <a href="{{ url('estados') }}" class="btn btn-secondary float-left">Volver</a>
                @if ($modo != 'show')
